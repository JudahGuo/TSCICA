% spm_hread() - reads a header (this function is adapted from
%               SPM'99)
%
% Usage:
...
% Author: FIL, 99/10/29
%
% See also: dbh.h (ANALYZE) spm_hwrite() spm_type()

% $Log: spm_hread.m,v $
% Revision 1.1  2003/02/06 19:46:10  duann
% Initial revision
%

function [DIM,VOX,SCALE,TYPE,OFFSET,ORIGIN,DESCRIP] = ICA_rtfmri_spm_hread(P)
% reads a header
